...
const entries: BrandEntry[] = [
  ...
  // ── Image Resizer Tools ───────────────────────────────────────────
  { slug: "canva",            name: "Canva",               abbr: "CA",  color1: "#00C4CC", color2: "#009DA3" },
  { slug: "squoosh",          name: "Squoosh",              abbr: "SQ",  color1: "#4285F4", color2: "#1565C0" },
  { slug: "iloveimg",         name: "ILoveIMG",             abbr: "IL",  color1: "#FF2E4C", color2: "#CC1E38" },
  { slug: "resizepixel",      name: "ResizePixel",          abbr: "RP",  color1: "#5C6BC0", color2: "#3F4FA5" },
  { slug: "bulkresizephotos", name: "BulkResizePhotos",     abbr: "BR",  color1: "#FF7043", color2: "#D9512B" },
  { slug: "kraken-io",        name: "Kraken.io",            abbr: "KR",  color1: "#7B2FF7", color2: "#5F1FCA" },
  { slug: "picresize",        name: "PicResize",            abbr: "PR",  color1: "#26A69A", color2: "#00796B" },
  { slug: "birme",            name: "BIRME",                abbr: "BI",  color1: "#42A5F5", color2: "#1565C0" },

  // ── PDF Converter Tools ───────────────────────────────────────────
  { slug: "adobe-acrobat",    name: "Adobe Acrobat Online", abbr: "AA",  color1: "#FF0000", color2: "#CC0000" },
  { slug: "smallpdf",         name: "Smallpdf",             abbr: "SP",  color1: "#E21111", color2: "#B50D0D" },
  { slug: "ilovepdf",         name: "ILovePDF",             abbr: "LP",  color1: "#E83750", color2: "#BA1E33" },
  { slug: "soda-pdf",         name: "Soda PDF",             abbr: "SD",  color1: "#00A8E8", color2: "#0080C8" },
  { slug: "pdf2doc",          name: "PDF2Doc",              abbr: "PD",  color1: "#FF5722", color2: "#E64A19" },
  { slug: "sejda",            name: "Sejda PDF",            abbr: "SJ",  color1: "#2196F3", color2: "#1565C0" },
  { slug: "pdf-candy",        name: "PDF Candy",            abbr: "PC",  color1: "#F06292", color2: "#C2185B" },
  { slug: "nitro-pdf",        name: "Nitro PDF",            abbr: "NP",  color1: "#1976D2", color2: "#0D47A1" },
  { slug: "cleverpdf",        name: "CleverPDF",            abbr: "CP",  color1: "#4CAF50", color2: "#2E7D32" },
  { slug: "pdf-co",           name: "PDF.co",               abbr: "PC",  color1: "#673AB7", color2: "#4527A0" },

  // ── PDF Editor Tools ──────────────────────────────────────────────
  { slug: "adobe-acrobat",    name: "Adobe Acrobat Pro",    abbr: "AA",  color1: "#FF0000", color2: "#CC0000" },
  { slug: "pdfelement",       name: "PDFelement",           abbr: "PE",  color1: "#4CAF50", color2: "#2E7D32" },
  { slug: "foxit",            name: "Foxit PDF Editor",     abbr: "FX",  color1: "#E53935", color2: "#B71C1C" },
  { slug: "nitro-pdf",        name: "Nitro Pro",            abbr: "NP",  color1: "#1976D2", color2: "#0D47A1" },
  { slug: "pdf-xchange",      name: "PDF-XChange Editor",   abbr: "PX",  color1: "#FF6F00", color2: "#E65100" },
  { slug: "updf",             name: "UPDF",                 abbr: "UP",  color1: "#00BCD4", color2: "#0097A7" },
  { slug: "pdf-expert",       name: "PDF Expert",           abbr: "PE",  color1: "#00897B", color2: "#00695C" },
  { slug: "sejda",            name: "Sejda PDF Editor",     abbr: "SJ",  color1: "#2196F3", color2: "#1565C0" },
  { slug: "kofax",            name: "Kofax Power PDF",      abbr: "KF",  color1: "#880E4F", color2: "#6A0136" },
  { slug: "smallpdf",         name: "Smallpdf Edit",        abbr: "SP",  color1: "#E21111", color2: "#B50D0D" },
];
