...
import { CommunityScreenshot } from "@/src/components/community/CommunityScreenshot";
...
export function AppDetail() {
  ...
  const seoContent = generateAppContent(app, feedback);
                  ...
                  <div className="relative group/img border-t border-b border-white/[0.06] bg-black/20">
                    ...
                    >
                      <CommunityScreenshot
                        ...
                        imageClassName="w-full max-h-[500px] object-contain"
                        fallbackTitle="Screenshot offline"
                        fallbackHint="This app preview could not be loaded right now."
                      />
                    </button>
                    {hasMultiple && (
                      <>
            ...
            >
              ...
              >
                ...
                <CommunityScreenshot
                  ...
                  imageClassName="max-w-full max-h-[80vh] rounded-lg object-contain"
                  fallbackTitle="Screenshot unavailable"
                  fallbackHint="The full-size image could not be loaded in the preview."
                />
                {hasMultiple && (
                  <button
