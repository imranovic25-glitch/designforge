...
export function Disclaimer() {
  return (
    <LegalPage title="Disclaimer" lastUpdated="March 1, 2026">
      <SEOHead
        title="Disclaimer — DesignForge360"
        description="Disclaimer for DesignForge360: our tools and content are for informational purposes. Read before using our services."
