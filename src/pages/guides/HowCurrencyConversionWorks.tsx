...
export function HowCurrencyConversionWorks() {
  return (
    ...
    >
      <SEOHead
        title="How Currency Conversion Works — Complete Explainer"
        description="A complete guide to how foreign exchange works, what drives currency rates, and how to get the best conversion rates when travelling or making international transfers."
        canonical="/guides/how-currency-conversion-works"
        schema="Article"
        ogType="article"
