  ...
  return (
    ...
    >
      <SEOHead
        ...
        faqItems={page.faq}
        howToSteps={[
          { name: "Open Image Converter", text: `Click the button to launch the converter for ${sourceLabel} to ${targetLabel} conversion.` },
          { name: "Upload your image", text: `Drag and drop your ${sourceLabel} file or click to browse. Processing happens entirely in your browser.` },
          { name: "Verify output format", text: `Confirm the target format is set to ${targetLabel}${quality ? ` at ${quality}% quality` : ''}.` },
          { name: "Convert and download", text: `Click Convert and download your ${targetLabel} file instantly.` },
        ]}
      />
