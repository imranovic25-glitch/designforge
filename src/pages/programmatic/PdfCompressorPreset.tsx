  ...
  return (
    ...
    >
      <SEOHead
        ...
        faqItems={page.faq}
        howToSteps={[
          { name: "Open PDF Compressor", text: "Click the button to launch the compression tool." },
          { name: "Upload your PDF", text: "Drag and drop your PDF file or click to browse. All processing happens in your browser." },
          { name: `Select ${level} compression`, text: `Choose the ${level} compression level for the optimal balance of size reduction and quality.` },
          { name: "Compress and download", text: "Click Compress, then download your smaller PDF file instantly." },
        ]}
      />
