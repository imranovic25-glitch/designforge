...
const faqItems = [
  {
    ...
    answer: "EMI (Equated Monthly Installment) is a fixed payment amount made by a borrower to a lender at a specified date each calendar month. It includes both principal and interest."
  },
  {
    question: "How is EMI calculated?",
    answer: "EMI = [P × R × (1+R)^N] / [(1+R)^N – 1], where P is the principal, R is the monthly interest rate, and N is the number of months."
  },
  {
    question: "What's the difference between monthly and yearly loan terms?",
    answer: "You can enter your loan term in either months or years. The calculator converts years to months automatically."
  }
];
...
export function LoanEmiCalculator() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Loan EMI Calculator — Calculate Monthly Payments Free"
        description="Calculate your monthly EMI for any home, car, or personal loan. Includes full amortisation schedule."
