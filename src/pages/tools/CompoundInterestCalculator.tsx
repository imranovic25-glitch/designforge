...
const faqItems = [
  {
    ...
    answer: "Compound interest is interest calculated on both the initial principal and the accumulated interest. Over time, this creates exponential growth compared to simple interest."
  },
  {
    question: "What is the compounding frequency?",
    answer: "This determines how often interest is added to your balance. Higher frequency (e.g., monthly vs. annually) results in slightly more growth over time."
  },
  {
    question: "What's the difference between principal and monthly contribution?",
    answer: "The principal is your initial investment. Monthly contributions are regular deposits you add over the investment period. Both grow with compound interest."
  }
];
