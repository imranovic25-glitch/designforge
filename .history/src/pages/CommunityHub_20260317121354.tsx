...
import { Search, Plus, SlidersHorizontal, ChevronDown, Home, TrendingUp, Heart, MessageSquare, FolderOpen, Send, Trophy, HelpCircle } from "lucide-react";
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white/[0.03] border border-white/[0.08] rounded-xl text-sm text-white/80 placeholder:text-white/30 focus:outline-none focus:border-white/25 transition-colors"
                  />
                </div>
                <button
