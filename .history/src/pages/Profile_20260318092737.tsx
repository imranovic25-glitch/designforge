        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            {[
              ...
              { label: "Community Repos", value: repoBalance.toString() },
            ].map((stat, i) => (
              <motion.div
                key={stat.label}
              ...
              >
                ...
                <div className="text-xs text-white/30 uppercase tracking-widest">
                  {stat.label}
                  {stat.label === "Community Repos" && admin && (
                    <span className="ml-2 text-[10px] px-2 py-0.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 align-middle">
                      Admin
                    </span>
                  )}
                </div>
