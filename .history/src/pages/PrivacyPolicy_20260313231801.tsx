...
export function PrivacyPolicy() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="March 1, 2026">
      <SEOHead
        title="Privacy Policy — DesignForge360"
        description="DesignForge360 privacy policy: how we handle your data, what we collect, and your rights."
      ...
      <h2>5. Your Rights</h2>
      <p>
        Depending on your location, you may have the right to access, correct, or delete personal data we hold about you. Since we collect very limited data, most users have no personal data stored on our systems. To exercise any rights, contact us at <a href="mailto:motionbox96@gmail.com">motionbox96@gmail.com</a>.
      </p>
