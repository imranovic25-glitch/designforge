...
import { ArrowRight, CreditCard, PieChart, TrendingUp, ShieldCheck, FileSearch, PenTool, Image as ImageIcon, Maximize2, FileOutput, FilePen } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {comparisons.map((comp, i) => (
            ...
            <Link to={comp.path} className="group glass-panel rounded-3xl overflow-hidden flex flex-col h-full transition-all duration-500 hover:-translate-y-2 hover:bg-orange-500/[0.03] hover:border-orange-500/20">
              <div className="h-48 bg-orange-500/5 flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/20"></div>
                <div className="text-orange-400/30 group-hover:text-orange-400 transition-colors transform group-hover:scale-110 duration-500 relative z-10">
                  {comp.icon}
                </div>
              </div>
