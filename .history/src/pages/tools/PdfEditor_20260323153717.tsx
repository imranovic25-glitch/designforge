...
export function PdfEditor() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const ctx = c.getContext("2d");
        if (!ctx) return;
        // Use higher resolution for sharper rendering (match device pixel ratio)
  ...
  const handleTextLayerClick = useCallback((e: React.MouseEvent) => {
    ...
    setAnns((a) => [...a, wo, ta]);
    setSelId(ta.id);
    // Don't exit editText mode — allow clicking more spans for batch editing
    // User can switch to "select" tool when done, then double-click to edit text
                ...
                <div className="relative inline-block shadow-2xl" style={{ width: cW, height: cH, flexShrink: 0 }}>
                  ...
                  <div ref={textLayerRef}
                    ...
                    style={{
                      ...
                      // TextLayer is always below the overlay visually
                      // In editText mode: visible + receives clicks through overlay's pointer-events:none
                  ...
                  <div ref={overlayRef}
                    ...
                    style={{
                      width: cW, height: cH, cursor: overlayCursor, zIndex: 10,
                      // In editText mode: let clicks pass through to TextLayer below,
                      // but annotations still render on top visually
