...
import { UploadCloud, Download, RefreshCw, CheckCircle2, FileText, FileDown } from "lucide-react";
...
const faqItems = [
  {
    ...
    a: "Our tool re-processes your PDF in the browser using pdf-lib, removing redundant metadata, compressing streams, and optimizing object references to reduce file size."
  },
  {
    q: "Will compression affect quality?",
    a: "At low compression, changes are nearly imperceptible. High compression may reduce embedded image quality slightly. Text and vector graphics are always preserved perfectly."
  },
  {
    q: "Is there a file size limit?",
    a: "The tool runs entirely in your browser. Large files may be slow to process on lower-end devices, but there is no hard server-side limit."
  },
  {
    q: "Are my files uploaded anywhere?",
    a: "No. All processing happens locally in your browser using pdf-lib. Your files never leave your device."
  }
];
  ...
  return (
    ...
    >
      <SEOHead
        ...
        description="Compress PDF files online for free. Drag, drop, and download. No file size limit, no watermark, no upload to our servers."
