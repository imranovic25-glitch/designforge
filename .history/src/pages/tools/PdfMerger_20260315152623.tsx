...
const faqItems = [
  {
    ...
    answer: "You can merge as many PDFs as you need. For very large batches, processing time will increase."
  },
  {
    question: "Will the merged PDF preserve all content?",
    answer: "Yes. Our tool copies all pages from each PDF exactly as they are, including text, images, and formatting."
  },
  {
    question: "Can I change the order of the PDFs?",
    answer: "Absolutely. Use the up and down arrows next to each file to reorder them before merging."
  },
  {
    question: "Are my files uploaded to a server?",
    answer: "No. All merging happens locally in your browser using pdf-lib. Your files never leave your device."
  }
];
