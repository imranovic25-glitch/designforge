...
export function PdfEditor() {
  ...
  const handleTextLayerClick = useCallback((e: React.MouseEvent) => {
    ...
    // Read exact position & size from the rendered span (already pixel-perfect from pdfjs)
    ...
    const fontSize = Math.round(parseFloat(cs.fontSize) / zoom) || 12;

    pushHistory();
    // Whiteout to cover original
    const pad = 1;
  ...
  }, [tool, pg, pos, addText, pdfTextBlocks]);
