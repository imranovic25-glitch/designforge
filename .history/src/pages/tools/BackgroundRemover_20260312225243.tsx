...
const faqItems = [
  {
    ...
    a: "Our tool uses AI-powered edge detection to identify the foreground subject and separate it from the background. The result is a transparent PNG you can place on any background."
  },
  {
...
export function BackgroundRemover() {
  ...
  const handleProcess = async () => {
    ...
    // For demo, use the original image since true AI processing requires a server
