...
const faqItems = [
  {
    ...
    answer: "Rates are fetched from ExchangeRate-API, which provides free, regularly-updated exchange rates for 160+ currencies."
  },
  {
    question: "How often are rates updated?",
    answer: "The free tier of ExchangeRate-API updates rates approximately every 24 hours. For real-time trading, always check with a financial institution."
  },
  {
    question: "Are the rates accurate for international transfers?",
    answer: "The mid-market rate shown is a reference rate. Banks and transfer services add a spread on top of this rate. Always compare providers before sending money internationally."
  }
];
...
const relatedComparisons = [
  ...
  { title: "Best Savings Accounts", path: "/comparisons/best-savings-accounts" },
];
...
export function CurrencyConverter() {
  ...
  return (
    <ToolLayout
      ...
      description="Convert between 160+ global currencies using live mid-market exchange rates. Updated daily."
    ...
    >
      <SEOHead
        ...
        description="Convert currencies with live exchange rates. 170+ currencies supported. Free, fast, no signup."
