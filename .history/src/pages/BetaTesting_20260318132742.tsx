...
export function BetaTesting() {
  ...
  return (
    <>
      ...
      {/* ── How DesignForge360 Compares ──────────────────────────── */}
      <section className="py-20 border-t border-white/5">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="text-2xl font-bold text-white text-center mb-4">
            How DesignForge360 Compares to Paid Beta Testing Services
          </h2>
          <p className="text-center text-white/40 mb-10 max-w-2xl mx-auto text-sm leading-relaxed">
            Enterprise testing services charge $30–$120 per tester session. Here's how our free community model stacks up.
          </p>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-center py-3 px-4 text-indigo-400 font-semibold">DesignForge360</th>
                  <th className="text-center py-3 px-4 text-white/50 font-medium">Paid Services</th>
                </tr>
              </thead>
              <tbody className="text-white/40">
                {[
                  ["Cost", "Free", "$30–$120/session"],
                  ["Tester motivation", "Genuine interest + Repo Points", "Financial payment"],
                  ["Feedback type", "Structured 6-dimension review", "Varies by provider"],
                  ["Tester audience", "Self-selected, category-aware", "Random panelists"],
                  ["Developer messaging", "Direct in-platform DMs", "Usually not available"],
                  ["Setup time", "Under 2 minutes", "Hours of configuration"],
                  ["Ongoing community", "Testers return for new builds", "One-time sessions"],
                ].map(([feature, df, paid], i) => (
                  <tr key={i} className="border-b border-white/5">
                    <td className="py-3 px-4 text-white/60">{feature}</td>
                    <td className="py-3 px-4 text-center text-emerald-400">{df}</td>
      ...
      <section className="py-20 border-t border-white/5">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="text-2xl font-bold text-white mb-6">
            Why Community-Driven Beta Testing Works
          </h2>
          <div className="space-y-4 text-sm text-white/45 leading-relaxed">
            <p>
              The most successful app launches in 2026 share one trait: they were tested by real users before going public. Not QA engineers running scripted test cases, not Selenium bots clicking through automated flows — real humans using the app the way they'd use it in daily life.
            </p>
            <p>
              Community-driven beta testing works because it aligns incentives correctly. Testers on DesignForge360 choose which apps to test based on genuine interest in the category — a gamer tests games, a finance enthusiast tests budgeting tools, a developer tests dev tools. This self-selection produces feedback that's deeply relevant to the app's target audience, not generic observations from disinterested panelists.
            </p>
            <p>
              The Repo Points system adds a quality layer: testers earn community reputation for detailed, helpful reviews — not for positive reviews. This eliminates the perverse incentive structure of paid testing services where testers rush through sessions to maximize hourly earnings.
            </p>
            <p>
              For developers, the value is clear: honest, detailed, structured feedback from your actual target audience — at zero cost. For testers, the value is equally clear: early access to apps before they're public, a voice in shaping products they care about, and community recognition for their expertise.
            </p>
          </div>

          <h3 className="text-lg font-semibold text-white mt-10 mb-4">
            What Types of Apps Get the Best Feedback?
          </h3>
          <div className="space-y-3 text-sm text-white/45 leading-relaxed">
            <p>
              Apps that perform best on DesignForge360 share three qualities: a clear description of what the app does, at least one screenshot showing the actual UI, and an explicit statement of what feedback the developer is looking for.
            </p>
            <p>
              Categories with the highest tester engagement include productivity tools (everyone wants a better task manager), games (testers love early access), and developer tools (developers are the most thorough testers). Finance and health apps receive fewer but higher-quality reviews — testers in these categories tend to be domain experts.
            </p>
          </div>
        </div>
      </section>
