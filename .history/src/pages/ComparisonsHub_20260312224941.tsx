    ...
    <div className="min-h-screen bg-black pt-32 pb-24 selection:bg-white/30 selection:text-white">
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
        <div className="max-w-3xl mb-24">
          <h1 className="text-5xl md:text-7xl font-semibold text-white tracking-tight mb-8 leading-[1.1]">Editorial Comparisons</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {comparisons.map((comp) => (
            <Link key={comp.id} to={comp.path} className="group glass-panel rounded-3xl overflow-hidden flex flex-col transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.04]">
