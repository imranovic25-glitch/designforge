...
export function About() {
  return (
    <LegalPage title="About DesignForge360">
      ...
      <h2>Contact Us</h2>
      <p>
        Have a question, suggestion, or want to report an issue? We'd love to hear from you. Visit our <a href="/contact">Contact page</a> to get in touch, or email us directly at <a href="mailto:motionbox96@gmail.com">motionbox96@gmail.com</a>. We are based in <strong>India</strong>.
      </p>
    </LegalPage>
  );
}
