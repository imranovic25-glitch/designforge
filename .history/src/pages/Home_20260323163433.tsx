...
export function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black selection:bg-white/30 selection:text-white">
      <SEOHead
        title="Free PDF Editor Online + 20 Free Tools — No Signup | DesignForge360"
        description="Edit PDFs online for free — no watermarks, no account. Plus 20+ free tools: EMI calculator, image compressor, background remover, JSON formatter, and more. Instant, browser-based."
        canonical="/"
        schema="WebSite"
      />
