    ...
    <>
      ...
      <div className="pt-[70px] h-screen flex flex-col">
        <div className="flex-1 flex max-w-[1400px] w-full mx-auto overflow-hidden">
          ...
          {/* ═══════ LEFT SIDEBAR ═══════ */}
          <aside className="hidden lg:flex flex-col w-[220px] shrink-0 border-r border-white/[0.06] overflow-y-auto community-scroll bg-[#0a0a0a]">
          ...
          {/* ═══════ RIGHT SIDEBAR ═══════ */}
          <aside className="hidden xl:flex flex-col w-[300px] shrink-0 border-l border-white/[0.06] overflow-y-auto community-scroll bg-[#0a0a0a]">
