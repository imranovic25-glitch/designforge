...
import { Landmark, ArrowRight, Calculator } from "lucide-react";
  ...
  return (
    ...
    >
      <SEOHead
        ...
        faqItems={page.faq}
        howToSteps={[
          { name: "Open EMI Calculator", text: "Click the button to launch the calculator with pre-filled loan details." },
          { name: "Enter loan amount", text: `Enter your loan principal amount (pre-filled at ${new Intl.NumberFormat('en-IN').format(loanAmount)}).` },
          { name: "Set interest rate and tenure", text: `Adjust the annual interest rate (${interestRate}%) and loan tenure (${loanTerm} ${termType}).` },
          { name: "View EMI breakdown", text: "See your monthly EMI, total interest payable, and full amortization schedule instantly." },
        ]}
      />
