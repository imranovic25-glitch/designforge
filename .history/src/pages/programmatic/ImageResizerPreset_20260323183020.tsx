...
import { Maximize2, ArrowRight, Image } from "lucide-react";
  ...
  return (
    ...
    >
      <SEOHead
        ...
        faqItems={page.faq}
        howToSteps={[
          { name: "Open Image Resizer", text: `Click "Open Image Resizer" to launch the tool with ${w}×${h} preset.` },
          { name: "Upload your image", text: "Drag and drop your image or click to browse. Supports JPG, PNG, and WebP." },
          { name: `Set dimensions to ${w}×${h}`, text: `Enter width ${w} and height ${h} in the dimension fields.` },
          { name: "Choose output format", text: "Select JPG, PNG, or WebP depending on your use case." },
          { name: "Download resized image", text: "Click Resize and download your image instantly — processed entirely in your browser." },
        ]}
      />
