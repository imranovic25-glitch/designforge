  ...
  return (
    ...
    >
      <SEOHead
        ...
        faqItems={page.faq}
        howToSteps={[
          { name: "Open Password Generator", text: `Open the generator pre-configured for ${presetLength}-character passwords.` },
          { name: "Review character settings", text: `Verify character types: ${types.join(', ')}${excludeAmbiguous ? ' (ambiguous characters excluded)' : ''}.` },
          { name: "Generate password", text: "Click Generate to create a cryptographically secure random password." },
          { name: "Copy to clipboard", text: "Click the copy button and paste the password into your password manager or account settings." },
        ]}
      />
