    ...
    <div className="flex flex-col min-h-screen bg-black selection:bg-white/30 selection:text-white">
      ...
      <section className="border-y border-white/5 bg-white/[0.02] py-10">
        <div className="container mx-auto px-6 lg:px-12">
          <p className="text-center text-[11px] tracking-[0.2em] uppercase text-white/25 font-medium mb-7">Trusted by professionals at</p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-40 grayscale">
            {/* Simple text wordmarks — clean, legible, monochrome */}
            {["Stripe", "Notion", "Linear", "Vercel", "Figma", "Loom"].map((name) => (
              <span key={name} className="text-base md:text-lg font-semibold tracking-tighter text-white select-none">{name}</span>
            ))}
          </div>
        </div>
      </section>
