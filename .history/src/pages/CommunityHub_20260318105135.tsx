...
import { Search, Plus, SlidersHorizontal, ChevronDown, Home, TrendingUp, Trophy, X, Coffee, Heart, HelpCircle, ShieldCheck, Sparkles, Trash2, Gift, Copy, Check, ChevronUp, Pin, Zap, Star, Coins } from "lucide-react";
...
import { getSubmissions, toggleUpvote, getUserUpvotes, getMyRepoBalance, isCommunityAdmin, claimWelcomeRepos, deleteAllSubmissions, getMyReferralCode } from "@/src/lib/community-store";
        ...
        <div className="flex-1 flex max-w-[1400px] w-full mx-auto overflow-hidden">
          ...
          <main className="flex-1 min-w-0 overflow-y-auto community-scroll">
            <div className="max-w-[680px] mx-auto px-4 lg:px-6 py-4">
              ...
              {/* Sort tabs (desktop) */}
              <div className="hidden lg:flex items-center gap-1 mb-4 rounded-xl bg-white/[0.02] border border-white/[0.06] p-1">
                <button
              ...
              {user && repoBalance !== null && (
                <div className="rounded-xl border border-white/[0.06] overflow-hidden">
                  <div className="bg-emerald-500/10 px-4 py-2.5">
                    <h3 className="text-[10px] font-bold text-emerald-400 uppercase tracking-wider">Your Repos</h3>
                  </div>
                  <div className="p-4 bg-white/[0.02]">
                    ...
                    <p className="text-[11px] text-white/35 mt-1">
                      Earn repos by reviewing apps. Posting costs <span className="text-orange-400/70 font-medium">15</span> repos.
                    </p>
                  </div>
                </div>
              )}
