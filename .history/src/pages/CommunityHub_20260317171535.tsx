...
import { Search, Plus, SlidersHorizontal, ChevronDown, Home, TrendingUp, Trophy, X } from "lucide-react";
        ...
        <div className="container mx-auto px-4 lg:px-6 max-w-[1200px]">
          ...
          <div className="flex gap-6">
            ...
            <main className="flex-1 min-w-0">
              {/* Sort tabs */}
              <div className="hidden lg:flex items-center gap-1 mb-4 rounded-xl border border-white/[0.06] bg-white/[0.02] p-1.5">
                <button
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                    sort === "most-upvoted" ? "bg-white/[0.1] text-white" : "text-white/40 hover:text-white/60"
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                    sort === "most-feedback" ? "bg-white/[0.1] text-white" : "text-white/40 hover:text-white/60"
                  }`}
                >
