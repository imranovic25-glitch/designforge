      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
        ...
        <section id="comparisons" className="mb-32 scroll-mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Link to="/finance/comparisons/best-mortgage-calculators" className="group flex flex-col sm:flex-row gap-8 glass-panel rounded-3xl p-8 hover:-translate-y-2 hover:bg-emerald-500/[0.03] hover:border-emerald-500/20 transition-all duration-500">
              <div className="bg-emerald-500/10 rounded-2xl w-full sm:w-32 h-32 flex items-center justify-center shrink-0">
        ...
        <section id="guides" className="mb-32 scroll-mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Link to="/finance/guides/how-mortgage-calculators-work" className="group block glass-panel rounded-3xl p-8 hover:-translate-y-2 hover:bg-emerald-500/[0.03] hover:border-emerald-500/20 transition-all duration-500">
