    ...
    <div className="flex flex-col min-h-screen bg-black selection:bg-white/30 selection:text-white">
      ...
      <section className="relative overflow-hidden pt-40 pb-32 lg:pt-52 lg:pb-44">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 75% 65% at 50% 45%, transparent 0%, black 95%)",
          }}
        />

        {/* Layer 5: Subtle dot grid */}
        <div className="absolute inset-0 opacity-[0.022] -z-[7] pointer-events-none" style={{ backgroundImage: "radial-gradient(circle, rgba(255,255,255,0.5) 1px, transparent 1px)", backgroundSize: "28px 28px" }} />

        {/* Layer 6: Extra accent glows for richness */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 -z-[6] pointer-events-none rounded-full" style={{ background: "radial-gradient(ellipse, rgba(139,92,246,0.08) 0%, transparent 70%)", filter: "blur(40px)" }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 -z-[6] pointer-events-none rounded-full" style={{ background: "radial-gradient(ellipse, rgba(59,130,246,0.07) 0%, transparent 70%)", filter: "blur(40px)" }} />
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-12 xl:gap-20">
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-violet-600/25 blur-[90px] rounded-full pointer-events-none" />
              <div className="absolute top-1/3 right-0 w-56 h-56 bg-blue-500/20 blur-[70px] rounded-full pointer-events-none" />
              <div className="absolute bottom-0 left-1/4 w-48 h-48 bg-indigo-500/15 blur-[60px] rounded-full pointer-events-none" />
