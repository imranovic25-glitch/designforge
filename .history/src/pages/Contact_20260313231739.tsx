    ...
    <LegalPage title="Contact Us">
      ...
      <div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
        <div className="glass-panel rounded-2xl p-8">
          ...
          <a href="mailto:motionbox96@gmail.com" className="text-white font-medium hover:text-white/70 transition-colors">motionbox96@gmail.com</a>
        </div>
        <div className="glass-panel rounded-2xl p-8">
          <div className="flex items-center gap-4 mb-4">
            <div className="h-10 w-10 rounded-xl bg-white/5 flex items-center justify-center text-white/70">
      ...
      <h2>Our Location</h2>
      <p>
        DesignForge360 is an online platform based in <strong>India</strong>. For all enquiries, please use the email address above.
      </p>
