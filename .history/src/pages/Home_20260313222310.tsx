          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-12 xl:gap-20">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="space-y-3">
                <p className="text-xs text-white/25 font-medium tracking-[0.15em] uppercase italic">Trusted by professionals worldwide</p>
                <div className="flex flex-wrap items-center gap-6 opacity-40">
                  {[
                    ...
                    <img key={brand.name} src={brand.src} alt={brand.name} className="h-5 w-auto brightness-0 invert object-contain" />
                  ))}
                </div>
              </motion.div>
            </motion.div>
