      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {tools.map((tool, i) => (
            ...
            <Link to={tool.path} className="group glass-panel rounded-3xl p-8 flex flex-col h-full transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.04]">
