...
import { ArrowRight, Search, Image as ImageIcon, FilePlus2, ArrowLeftRight, TrendingUp, Landmark, ArrowUpRight } from "lucide-react";
...
/** Animated compress icon — matches the PDF Compressor tool page */
function PdfCompressIcon() {
  const bars = [36, 28, 20, 13, 7];
  return (
    <div className="w-6 h-6 flex items-end justify-center gap-[2px]">
      {bars.map((h, i) => (
        <motion.div key={i}
          ...
          animate={{ height: h * 0.55, opacity: 1 }}
