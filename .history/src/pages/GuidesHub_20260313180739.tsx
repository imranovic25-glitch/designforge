      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {guides.map((guide, i) => (
            ...
            <Link to={guide.path} className="group glass-panel rounded-3xl p-8 flex flex-col transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.04] h-full">
