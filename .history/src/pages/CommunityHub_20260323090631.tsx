...
import { absolutePublicAssetUrl } from "@/src/lib/public-assets";
...
export function CommunityHub() {
  ...
  return (
    <>
      <SEOHead
        title="App Testers Community — Free Beta Testing & App Feedback Platform"
        description="Submit your app to thousands of real beta testers. Get honest feedback, earn Repo Points, boost visibility, and discover indie apps. Free for developers, indie hackers, and creators."
        canonical="/community"
        ogImage={absolutePublicAssetUrl("/og-default.png")}
        schema="SoftwareApplication"
        memberCount={memberCount ?? undefined}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "App Testers Community", url: "/community" },
        ]}
        faqItems={[
          { question: "What is the App Testers Community?", answer: "App Testers Community is a free platform on DesignForge360 where developers, indie hackers, and creators submit their apps to receive honest feedback from real users around the world." },
          { question: "How do I get beta testers for my app?", answer: "Sign in, earn at least 15 Repo Points (given free on sign-up), then submit your app. The community will see your listing and can leave detailed feedback, upvotes, likes, and comments." },
          { question: "What are Repo Points and how do I earn them?", answer: "Repo Points are community credits. You receive 15 free points on sign-up. Earn more by writing feedback (+1), upvoting (+1), liking (+1), loving (+1), sharing (+2), referring friends (+30), or getting referred (+10)." },
          { question: "What is a Pinned post in the App Testers Community?", answer: "Pinning a post costs 25 Repo Points and keeps your app at the very top of the community feed for 24 hours, dramatically increasing visibility to active testers." },
          { question: "What is a Boosted post?", answer: "Boosting costs 25 Repo Points and highlights your app listing with a special badge for 48 hours, attracting more testers and feedback." },
          { question: "What is Priority Review?", answer: "Priority Review costs 10 Repo Points and flags your submission for expedited attention from community moderators and active reviewers." },
          { question: "Is the App Testers Community free to join?", answer: "Yes, joining and participating in the App Testers Community is completely free. You only spend Repo Points — which you earn through participation — on optional power-up features." },
          { question: "Can I submit a website or YouTube channel, not just an app?", answer: "Yes. You can submit Android, iOS, web apps, desktop software, websites, YouTube channels, and services for community feedback." },
        ]}
      />
