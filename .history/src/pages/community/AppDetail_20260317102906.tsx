            ...
            <div className="flex items-center gap-3 flex-wrap mb-12">
              ...
              {user && !isOwner && !reportSent && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs text-white/25 hover:text-red-400 hover:bg-red-500/10 transition-all ml-auto"
                >
                  <Flag size={13} />
                  Report
                </button>
                ...
                >
                  ...
                  >
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white/80 placeholder:text-white/20 focus:outline-none focus:border-white/20 resize-none"
                    />
