...
import { ArrowLeft, ArrowUp, ExternalLink, Clock, MessageSquare, User, Eye, BarChart2, Share2, Flag, MessageCircle, X, ChevronLeft, ChevronRight, LinkIcon, Send, Heart, Paperclip, Image as ImageIcon } from "lucide-react";
      ...
      <div className="min-h-screen pt-28 pb-20">
        <div className="container mx-auto px-4 lg:px-6 max-w-[1200px]">
          ...
          >
            ...
            {/* Reddit-style combined card */}
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 mb-6 space-y-4">
