      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        {toolSlug && (
          <RevealOnScroll delay={0.15}>
            <ReviewSection toolSlug={toolSlug} />
          </RevealOnScroll>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl border border-white/[0.07] bg-white/[0.02] p-8 text-center">
              ...
              <h3 className="text-sm font-medium text-white mb-2">Support This Project</h3>
              <p className="text-xs text-white/35 mb-5 leading-relaxed">All tools are free. If this saved you time, consider buying us a coffee.</p>
              <Link
                to="/support"
                className="inline-flex items-center gap-1.5 text-xs font-medium text-white/60 hover:text-white border border-white/10 hover:border-white/20 rounded-full px-4 py-2 transition-colors"
              >
