...
import { ArrowUp, MessageSquare, ImageIcon, Rocket, Share2, X, Eye, ChevronLeft, ChevronRight, Heart, ThumbsUp, Pin, Zap, Star } from "lucide-react";
      ...
      >
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] hover:border-blue-500/15 transition-all duration-300">
          ...
          <div className="flex items-center gap-2 px-4 pt-3 pb-2">
            ...
            <span className="text-[12px] text-white/60 font-medium">{app.user_name || "Anonymous"}</span>
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              {app.is_pinned && (
                <span className="flex items-center gap-0.5 text-[9px] font-bold uppercase tracking-wider bg-amber-500/15 text-amber-400 px-1.5 py-0.5 rounded">
                  <Pin className="w-2.5 h-2.5" /> Pinned
                </span>
              )}
              {app.is_boosted && (
                <span className="flex items-center gap-0.5 text-[9px] font-bold uppercase tracking-wider bg-pink-500/15 text-pink-400 px-1.5 py-0.5 rounded">
                  <Zap className="w-2.5 h-2.5" /> Boosted
                </span>
              )}
              {app.priority_review && (
                <span className="flex items-center gap-0.5 text-[9px] font-bold uppercase tracking-wider bg-blue-500/15 text-blue-400 px-1.5 py-0.5 rounded">
          ...
          <div className="px-4 pb-3">
            ...
            <span className="text-[10px] text-white/35 uppercase tracking-wider">{CATEGORY_LABELS[app.category]}</span>
          </div>
              ...
              >
                <div className="relative mx-0 overflow-hidden">
                  <CommunityScreenshot
                    ...
                    imageClassName="w-full max-h-[480px] object-cover transition-transform duration-500 group-hover:scale-[1.02]"
                    fallbackTitle="Screenshot offline"
                    fallbackHint="This preview is temporarily unavailable. Open the app page or external link to continue."
                  />
                  {hasMultiple && (
          ...
          >
            ...
            >
              ...
              <CommunityScreenshot
                ...
                wrapperClassName="max-w-full max-h-[80vh] rounded-lg"
                imageClassName="max-w-full max-h-[80vh] object-contain rounded-lg"
                fallbackTitle="Full-size screenshot unavailable"
                fallbackHint="The original image could not be loaded in the lightbox."
              />
              {hasMultiple && (
                <button
            ...
            >
              ...
              <p className="text-white/60 text-sm leading-relaxed line-clamp-3">{app.description}</p>
