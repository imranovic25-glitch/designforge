...
import { ArrowUp, MessageSquare, ImageIcon, Rocket, Share2, X, Eye, ChevronLeft, ChevronRight, Heart, ThumbsUp } from "lucide-react";
          ...
          <div className="flex items-center gap-1.5 px-3 py-2 border-t border-white/[0.06]">
            ...
            <button
              ...
              className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-[12px] transition-all ${
                liked ? "text-blue-400 bg-blue-500/10" : "text-white/35 hover:text-blue-400 hover:bg-white/[0.05]"
              }`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-[12px] transition-all ${
                loved ? "text-pink-400 bg-pink-500/10" : "text-white/35 hover:text-pink-400 hover:bg-white/[0.05]"
              }`}
            >
