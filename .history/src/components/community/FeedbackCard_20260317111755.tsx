...
import { Star, Trash2, MessageCircle, Send, ChevronDown, ChevronUp } from "lucide-react";
...
export function FeedbackCard({ feedback, currentUserId, onDelete, replies = [], onReply, onDeleteReply }: FeedbackCardProps) {
