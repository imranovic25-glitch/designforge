...
const SubmitApp = lazy(() => import("./pages/community/SubmitApp").then(m => ({ default: m.SubmitApp })));
const AppDetail = lazy(() => import("./pages/community/AppDetail").then(m => ({ default: m.AppDetail })));
const MyApps = lazy(() => import("./pages/community/MyApps").then(m => ({ default: m.MyApps })));
const CommunityChat = lazy(() => import("./pages/community/CommunityChat").then(m => ({ default: m.CommunityChat })));
const ChatModeration = lazy(() => import("./pages/community/ChatModeration").then(m => ({ default: m.ChatModeration })));
const CategoryHub = lazy(() => import("./pages/community/CategoryHub").then(m => ({ default: m.CategoryHub })));
const PlatformHub = lazy(() => import("./pages/community/PlatformHub").then(m => ({ default: m.PlatformHub })));
const BetaTesting = lazy(() => import("./pages/BetaTesting").then(m => ({ default: m.BetaTesting })));
...
const PdfEditor = lazy(() => import("./pages/tools/PdfEditor").then(m => ({ default: m.PdfEditor })));
...
const ImageResizerPreset = lazy(() => import("./pages/programmatic/ImageResizerPreset").then(m => ({ default: m.ImageResizerPreset })));
const PdfCompressorPreset = lazy(() => import("./pages/programmatic/PdfCompressorPreset").then(m => ({ default: m.PdfCompressorPreset })));
const EmiPreset = lazy(() => import("./pages/programmatic/EmiPreset").then(m => ({ default: m.EmiPreset })));
const CompoundInterestPreset = lazy(() => import("./pages/programmatic/CompoundInterestPreset").then(m => ({ default: m.CompoundInterestPreset })));
const ImageConverterPreset = lazy(() => import("./pages/programmatic/ImageConverterPreset").then(m => ({ default: m.ImageConverterPreset })));
const PasswordPreset = lazy(() => import("./pages/programmatic/PasswordPreset").then(m => ({ default: m.PasswordPreset })));
    ...
    <BrowserRouter>
      <Suspense fallback={<div className="flex items-center justify-center min-h-screen bg-black text-white/40 text-sm">Loading…</div>}>
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route path="community/submit" element={<SubmitApp />} />
          <Route path="community/app/:id" element={<AppDetail />} />
          <Route path="community/my-apps" element={<MyApps />} />
          <Route path="community/chat" element={<CommunityChat />} />
          <Route path="community/moderation" element={<ChatModeration />} />
          <Route path="community/category/:category" element={<CategoryHub />} />
          <Route path="community/platform/:platform" element={<PlatformHub />} />
          <Route path="find-app-testers" element={<BetaTesting />} />
          <Route path="get-beta-testers" element={<BetaTesting />} />
          <Route path="test-my-app" element={<BetaTesting />} />
          <Route path="free-app-testing" element={<BetaTesting />} />
          ...
          {/* Programmatic SEO — Image Resizer presets */}
          <Route path="tools/resize-image-to-1080x1080" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-to-1920x1080" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-to-1200x628" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-for-instagram-post" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-for-instagram-story" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-for-youtube-thumbnail" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-for-facebook-cover" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-for-linkedin-banner" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-to-800x800" element={<ImageResizerPreset />} />
          <Route path="tools/resize-image-to-500x500" element={<ImageResizerPreset />} />

          {/* Programmatic SEO — PDF Compressor presets */}
          <Route path="tools/compress-pdf-to-1mb" element={<PdfCompressorPreset />} />
          <Route path="tools/compress-pdf-to-500kb" element={<PdfCompressorPreset />} />
          <Route path="tools/compress-pdf-to-200kb" element={<PdfCompressorPreset />} />
          <Route path="tools/compress-pdf-for-email" element={<PdfCompressorPreset />} />
          <Route path="tools/compress-pdf-for-whatsapp" element={<PdfCompressorPreset />} />
          <Route path="tools/compress-pdf-for-college-application" element={<PdfCompressorPreset />} />
          <Route path="tools/compress-pdf-for-job-application" element={<PdfCompressorPreset />} />

          {/* Programmatic SEO — EMI Calculator presets */}
          <Route path="tools/emi-for-5-lakh-loan" element={<EmiPreset />} />
          <Route path="tools/emi-for-10-lakh-loan" element={<EmiPreset />} />
          <Route path="tools/emi-for-20-lakh-loan" element={<EmiPreset />} />
          <Route path="tools/emi-for-50-lakh-loan" element={<EmiPreset />} />
          <Route path="tools/emi-for-3-lakh-loan" element={<EmiPreset />} />

          {/* Programmatic SEO — Compound Interest / SIP presets */}
          <Route path="tools/compound-interest-on-1000-monthly" element={<CompoundInterestPreset />} />
          <Route path="tools/compound-interest-on-5000-monthly" element={<CompoundInterestPreset />} />
          <Route path="tools/compound-interest-on-10000-monthly" element={<CompoundInterestPreset />} />
          <Route path="tools/sip-calculator-5000-per-month" element={<CompoundInterestPreset />} />
          <Route path="tools/sip-calculator-10000-per-month" element={<CompoundInterestPreset />} />

          {/* Programmatic SEO — Image Converter presets */}
          <Route path="tools/convert-png-to-jpg" element={<ImageConverterPreset />} />
          <Route path="tools/convert-jpg-to-png" element={<ImageConverterPreset />} />
          <Route path="tools/convert-png-to-webp" element={<ImageConverterPreset />} />
          <Route path="tools/convert-webp-to-jpg" element={<ImageConverterPreset />} />
          <Route path="tools/convert-webp-to-png" element={<ImageConverterPreset />} />
          <Route path="tools/convert-jpg-to-webp" element={<ImageConverterPreset />} />

          {/* Programmatic SEO — Password Generator presets */}
          <Route path="tools/generate-16-character-password" element={<PasswordPreset />} />
          <Route path="tools/generate-32-character-password" element={<PasswordPreset />} />
          <Route path="tools/generate-wifi-password" element={<PasswordPreset />} />
          <Route path="tools/generate-pin-code" element={<PasswordPreset />} />
          ...
          <Route path="finance/comparisons/best-credit-cards" element={<Navigate to="/comparisons/best-credit-cards" replace />} />
          <Route path="finance/comparisons/best-budgeting-apps" element={<Navigate to="/comparisons/best-budgeting-apps" replace />} />
          <Route path="finance/comparisons/best-investing-apps" element={<Navigate to="/comparisons/best-investing-apps" replace />} />
          <Route path="finance/comparisons/best-savings-accounts" element={<Navigate to="/comparisons/best-savings-accounts" replace />} />
          <Route path="finance/comparisons/best-mortgage-calculators" element={<Navigate to="/comparisons/best-mortgage-calculators" replace />} />
          ...
          <Route path="finance/guides/compound-interest-explained" element={<Navigate to="/guides/compound-interest-explained" replace />} />
          <Route path="finance/guides/how-loan-emi-works" element={<Navigate to="/guides/how-loan-emi-works" replace />} />
          <Route path="finance/guides/how-currency-conversion-works" element={<Navigate to="/guides/how-currency-conversion-works" replace />} />
          <Route path="finance/guides/how-to-compare-credit-cards" element={<Navigate to="/guides/how-to-compare-credit-cards" replace />} />
          <Route path="finance/guides/how-mortgage-calculators-work" element={<Navigate to="/guides/how-mortgage-calculators-work" replace />} />
