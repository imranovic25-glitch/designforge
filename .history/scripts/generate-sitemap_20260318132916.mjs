...
const STATIC_URLS = [
  ...
  url("/community/submit", "monthly", "0.6", TODAY),
  ...
  /* Tools */
  url("/tools/background-remover", "weekly", "0.8", TODAY),
  url("/tools/pdf-compressor", "weekly", "0.8", TODAY),
  url("/tools/pdf-merger", "weekly", "0.8", TODAY),
  url("/tools/pdf-to-word", "weekly", "0.8", TODAY),
  url("/tools/currency-converter", "weekly", "0.8", TODAY),
  url("/tools/compound-interest-calculator", "weekly", "0.8", TODAY),
  url("/tools/loan-emi-calculator", "weekly", "0.8", TODAY),
  url("/tools/resume-builder", "weekly", "0.8", TODAY),
  url("/tools/image-compressor", "weekly", "0.8", TODAY),
  url("/tools/image-converter", "weekly", "0.8", TODAY),
  url("/tools/image-resizer", "weekly", "0.8", TODAY),
  url("/tools/word-counter", "weekly", "0.8", TODAY),
  url("/tools/json-formatter", "weekly", "0.8", TODAY),
  url("/tools/clipboard-manager", "weekly", "0.8", TODAY),
  url("/tools/word-to-pdf", "weekly", "0.8", TODAY),
  url("/tools/markdown-preview", "weekly", "0.8", TODAY),
  url("/tools/qr-code-generator", "weekly", "0.8", TODAY),
  url("/tools/color-palette-generator", "weekly", "0.8", TODAY),
  url("/tools/svg-to-png", "weekly", "0.8", TODAY),
  url("/tools/password-generator", "weekly", "0.8", TODAY),
  url("/tools/mortgage-calculator", "weekly", "0.8", TODAY),
  url("/tools/seo-audit", "weekly", "0.8", TODAY),
  /* Programmatic — Image Resizer */
  url("/tools/resize-image-to-1080x1080", "monthly", "0.8", TODAY),
  url("/tools/resize-image-to-1920x1080", "monthly", "0.8", TODAY),
  url("/tools/resize-image-to-1200x628", "monthly", "0.8", TODAY),
  url("/tools/resize-image-for-instagram-post", "monthly", "0.8", TODAY),
  url("/tools/resize-image-for-instagram-story", "monthly", "0.8", TODAY),
  url("/tools/resize-image-for-youtube-thumbnail", "monthly", "0.8", TODAY),
  url("/tools/resize-image-for-facebook-cover", "monthly", "0.8", TODAY),
  url("/tools/resize-image-for-linkedin-banner", "monthly", "0.8", TODAY),
  url("/tools/resize-image-to-800x800", "monthly", "0.7", TODAY),
  url("/tools/resize-image-to-500x500", "monthly", "0.7", TODAY),
  /* Programmatic — PDF Compressor */
  url("/tools/compress-pdf-to-1mb", "monthly", "0.8", TODAY),
  url("/tools/compress-pdf-to-500kb", "monthly", "0.8", TODAY),
  url("/tools/compress-pdf-to-200kb", "monthly", "0.8", TODAY),
  url("/tools/compress-pdf-for-email", "monthly", "0.8", TODAY),
  url("/tools/compress-pdf-for-whatsapp", "monthly", "0.8", TODAY),
  url("/tools/compress-pdf-for-college-application", "monthly", "0.7", TODAY),
  url("/tools/compress-pdf-for-job-application", "monthly", "0.7", TODAY),
  /* Programmatic — EMI Calculator */
  url("/tools/emi-for-5-lakh-loan", "monthly", "0.8", TODAY),
  url("/tools/emi-for-10-lakh-loan", "monthly", "0.8", TODAY),
  url("/tools/emi-for-20-lakh-loan", "monthly", "0.8", TODAY),
  url("/tools/emi-for-50-lakh-loan", "monthly", "0.8", TODAY),
  url("/tools/emi-for-3-lakh-loan", "monthly", "0.7", TODAY),
  /* Programmatic — Compound Interest / SIP */
  url("/tools/compound-interest-on-1000-monthly", "monthly", "0.8", TODAY),
  url("/tools/compound-interest-on-5000-monthly", "monthly", "0.8", TODAY),
  url("/tools/compound-interest-on-10000-monthly", "monthly", "0.8", TODAY),
  url("/tools/sip-calculator-5000-per-month", "monthly", "0.8", TODAY),
  url("/tools/sip-calculator-10000-per-month", "monthly", "0.8", TODAY),
  /* Programmatic — Image Converter */
  url("/tools/convert-png-to-jpg", "monthly", "0.8", TODAY),
  url("/tools/convert-jpg-to-png", "monthly", "0.8", TODAY),
  url("/tools/convert-png-to-webp", "monthly", "0.8", TODAY),
  url("/tools/convert-webp-to-jpg", "monthly", "0.8", TODAY),
  url("/tools/convert-webp-to-png", "monthly", "0.8", TODAY),
  url("/tools/convert-jpg-to-webp", "monthly", "0.8", TODAY),
  /* Programmatic — Password Generator */
  url("/tools/generate-16-character-password", "monthly", "0.7", TODAY),
  url("/tools/generate-32-character-password", "monthly", "0.7", TODAY),
  url("/tools/generate-wifi-password", "monthly", "0.7", TODAY),
  url("/tools/generate-pin-code", "monthly", "0.7", TODAY),
  /* Comparisons */
  ...
  /* Guides */
  url("/guides/how-to-remove-image-background", "monthly", "0.7", TODAY),
  url("/guides/how-to-compress-pdf", "monthly", "0.7", TODAY),
  url("/guides/how-to-merge-pdf-files", "monthly", "0.7", TODAY),
  url("/guides/how-currency-conversion-works", "monthly", "0.7", TODAY),
  url("/guides/compound-interest-explained", "monthly", "0.7", TODAY),
  url("/guides/how-loan-emi-works", "monthly", "0.7", TODAY),
  url("/guides/how-to-compare-credit-cards", "monthly", "0.7", TODAY),
  url("/guides/how-to-choose-a-resume-builder", "monthly", "0.7", TODAY),
  url("/guides/how-to-choose-ai-writing-tools", "monthly", "0.7", TODAY),
  url("/guides/how-mortgage-calculators-work", "monthly", "0.7", TODAY),
  url("/guides/how-to-create-strong-passwords", "monthly", "0.7", TODAY),
  url("/guides/how-to-use-qr-codes-effectively", "monthly", "0.7", TODAY),
  url("/guides/how-to-choose-a-color-palette", "monthly", "0.7", TODAY),
  url("/guides/how-to-write-markdown", "monthly", "0.7", TODAY),
  url("/guides/how-to-use-seo-analyzer", "monthly", "0.7", TODAY),
];
