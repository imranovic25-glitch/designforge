...
const brands = [
  ...
  // Image Resizer Tools
  { slug: "canva",            abbr: "CA", name: "Canva",              c1: "#00C4CC", c2: "#009DA3" },
  { slug: "squoosh",          abbr: "SQ", name: "Squoosh",            c1: "#4285F4", c2: "#1565C0" },
  { slug: "iloveimg",         abbr: "IL", name: "ILoveIMG",           c1: "#FF2E4C", c2: "#CC1E38" },
  { slug: "resizepixel",      abbr: "RP", name: "ResizePixel",        c1: "#5C6BC0", c2: "#3F4FA5" },
  { slug: "bulkresizephotos", abbr: "BR", name: "BulkResize",         c1: "#FF7043", c2: "#D9512B" },
  { slug: "kraken-io",        abbr: "KR", name: "Kraken.io",          c1: "#7B2FF7", c2: "#5F1FCA" },
  { slug: "picresize",        abbr: "PR", name: "PicResize",          c1: "#26A69A", c2: "#00796B" },
  { slug: "birme",            abbr: "BI", name: "BIRME",              c1: "#42A5F5", c2: "#1565C0" },
  // PDF Converter / Editor Tools
  { slug: "adobe-acrobat",    abbr: "AA", name: "Adobe Acrobat",      c1: "#FF0000", c2: "#CC0000" },
  { slug: "smallpdf",         abbr: "SP", name: "Smallpdf",           c1: "#E21111", c2: "#B50D0D" },
  { slug: "ilovepdf",         abbr: "LP", name: "ILovePDF",           c1: "#E83750", c2: "#BA1E33" },
  { slug: "soda-pdf",         abbr: "SD", name: "Soda PDF",           c1: "#00A8E8", c2: "#0080C8" },
  { slug: "pdf2doc",          abbr: "PD", name: "PDF2Doc",            c1: "#FF5722", c2: "#E64A19" },
  { slug: "sejda",            abbr: "SJ", name: "Sejda",              c1: "#2196F3", c2: "#1565C0" },
  { slug: "pdf-candy",        abbr: "PC", name: "PDF Candy",          c1: "#F06292", c2: "#C2185B" },
  { slug: "nitro-pdf",        abbr: "NP", name: "Nitro PDF",          c1: "#1976D2", c2: "#0D47A1" },
  { slug: "cleverpdf",        abbr: "CP", name: "CleverPDF",          c1: "#4CAF50", c2: "#2E7D32" },
  { slug: "pdf-co",           abbr: "PC", name: "PDF.co",             c1: "#673AB7", c2: "#4527A0" },
  { slug: "pdfelement",       abbr: "PE", name: "PDFelement",         c1: "#4CAF50", c2: "#2E7D32" },
  { slug: "foxit",            abbr: "FX", name: "Foxit",              c1: "#E53935", c2: "#B71C1C" },
  { slug: "pdf-xchange",      abbr: "PX", name: "PDF-XChange",        c1: "#FF6F00", c2: "#E65100" },
  { slug: "updf",             abbr: "UP", name: "UPDF",               c1: "#00BCD4", c2: "#0097A7" },
  { slug: "pdf-expert",       abbr: "PE", name: "PDF Expert",         c1: "#00897B", c2: "#00695C" },
  { slug: "kofax",            abbr: "KF", name: "Kofax",              c1: "#880E4F", c2: "#6A0136" },
];
